...
PICS = (environ.get('PICS', 'https://envs.sh/94o.jpg')).split() #SAMPLE PIC
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://paid:bot@cluster0.w2x7q.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
